...
def llamar_ia_en_cascada(prompt):
    """
    Llamada en cascada a los modelos de OpenAI, con listado de modelos disponibles.
    Solo reemplaza la función de IA, mantiene todo lo demás blindado.
    """
    if not API_KEY:
        return "⚠️ Error: API Key no configurada."

    modelos = ["gpt-4o-mini", "gpt-4o"]  # aquí puedes actualizar modelos disponibles
